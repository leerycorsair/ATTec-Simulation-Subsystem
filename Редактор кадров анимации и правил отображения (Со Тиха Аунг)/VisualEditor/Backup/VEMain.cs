            ...
            try
            {
                ...
                if (newForm.ShowDialog() == DialogResult.OK)
                {
                    ...
                    else
                    {
                        ...
                        treeView1.SelectedNode.Nodes[1].Nodes.Add(newNode22);
                        TreeNode newNode23 = new TreeNode();
                        newNode23.Text = "_" + newForm.yCoordination;
                        treeView1.SelectedNode.Nodes[1].Nodes.Add(newNode23);
                    }
                }
            }
            catch (Exception ex)
