...
namespace Visualization
{
    public class Writer
    {
        ...
        {
            writer = new XmlTextWriter(Path + "123.xml", null);
        ...
        {
            writer.WriteStartElement("Параметр_типа");
            writer.WriteAttributeString("Имя_параметра", resparam.Name);
            writer.WriteAttributeString("Тип_параметра", resparam.Type);
            writer.WriteAttributeString("Умолчание", resparam.Default);
            writer.WriteEndElement();
        }

        private static void addResourseType(ResourceType restype, XmlTextWriter writer)
        {
            writer.WriteStartElement("Тип_ресурсов");
            writer.WriteAttributeString("Имя_типа_ресурсов", restype.Name);
            writer.WriteAttributeString("Вид_типа_ресурсов", restype.Type);
